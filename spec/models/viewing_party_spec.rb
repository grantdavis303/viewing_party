...
RSpec.describe ViewingParty, type: :model do
  before(:each) do
      @user_1 = User.create!(name: 'Sam', email: 'sam@email.com', password: "test", password_confirmation: "test")
      @user_2 = User.create!(name: 'Tommy', email: 'tommy@email.com', password: "test", password_confirmation: "test")
