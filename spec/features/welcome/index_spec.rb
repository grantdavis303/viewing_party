...
RSpec.describe 'Root Page, Welcome Index', type: :feature do
   describe 'When a user visits the root path "/"' do
      before(:each) do
         @user_1 = User.create!(name: 'Sam', email: 'sam_t@email.com', password: "test", password_confirmation: "test")
         @user_2 = User.create!(name: 'Tommy', email: 'tommy_t@gmail.com', password: "test", password_confirmation: "test")
